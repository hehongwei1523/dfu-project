...
/*************************************************************************************
    ...
    Description :   One of the openTestEngine... set of functions has to called 
                    ...
                    protocol running over USB or a UART. To open a SPI connection, 
                    use openTestEngineSpi or openTestEngineSpiTrans.
...
/*************************************************************************************
    ...
    Description :   One of the openTestEngine... set of functions has to called 
                    before any communication with BlueCore can begin.
                    <p>This function opens a SPI connection. To open a host transport 
                    connection, use openTestEngine. openTestEngineSpiTrans can also 
                    be used to open a SPI connection.
...
/*************************************************************************************
    ...
    Description :   One of the openTestEngine... set of functions has to called 
                    before any communication with BlueCore can begin.
                    <p>This function opens a SPI connection. To open a host transport 
                    connection, use openTestEngine. openTestEngineSpi can also 
                    be used to open a SPI connection.
